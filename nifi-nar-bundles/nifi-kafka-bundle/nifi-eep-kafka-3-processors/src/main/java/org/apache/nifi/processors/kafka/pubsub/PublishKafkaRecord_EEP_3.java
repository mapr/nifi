...
@Tags({"EEP", "MapR", "Kafka", "Record", "csv", "json", "avro", "logs", "Put", "Send", "Message", "PubSub", "3.0"})
@CapabilityDescription("Sends the contents of a FlowFile as individual records to EEP Kafka using the Kafka 3.0 Producer API. "
        + "The contents of the FlowFile are expected to be record-oriented data that can be read by the configured Record Reader. "
        + "The complementary NiFi processor for fetching messages is ConsumeKafkaRecord_EEP_3.")
@SeeAlso({PublishKafka_EEP_3.class, ConsumeKafka_EEP_3.class, ConsumeKafkaRecord_EEP_3.class})
public class PublishKafkaRecord_EEP_3 extends PublishKafkaRecord_3 {

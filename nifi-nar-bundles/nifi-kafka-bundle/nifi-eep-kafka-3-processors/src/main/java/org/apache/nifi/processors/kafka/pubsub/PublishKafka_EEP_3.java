...
@Tags({"EEP", "MapR", "Kafka", "Put", "Send", "Message", "PubSub", "3.0"})
@CapabilityDescription("Sends the contents of a FlowFile as a message to EEP Kafka using the Kafka 3.0 Producer API."
        + "The messages to send may be individual FlowFiles or may be delimited, using a "
        + "user-specified delimiter, such as a new-line. "
        + "The complementary NiFi processor for fetching messages is ConsumeKafka_EEP_3.")
public class PublishKafka_EEP_3 extends PublishKafka_3 {

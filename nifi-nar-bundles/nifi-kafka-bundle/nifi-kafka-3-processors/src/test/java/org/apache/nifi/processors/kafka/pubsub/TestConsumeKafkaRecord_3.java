...
public class TestConsumeKafkaRecord_3 {
    ...
    public void setup() throws InitializationException {
        ...
        ConsumeKafkaRecord_3 proc = new ConsumeKafkaRecord_3() {
            @Override
        ...
        runner.setProperty(ConsumeKafkaRecord_3.BOOTSTRAP_SERVERS, "okeydokey:1234");
        ...
        runner.setProperty(ConsumeKafkaRecord_3.RECORD_READER, readerId);
        runner.setProperty(ConsumeKafkaRecord_3.RECORD_WRITER, writerId);
    }

    @Test
    public void validateCustomValidatorSettings() {
        runner.setProperty(ConsumeKafkaRecord_3.TOPICS, "foo");
        runner.setProperty(ConsumeKafkaRecord_3.GROUP_ID, "foo");
        runner.setProperty(ConsumeKafkaRecord_3.AUTO_OFFSET_RESET, ConsumeKafkaRecord_3.OFFSET_EARLIEST);
    ...
    public void validatePropertiesValidation() {
        ...
        runner.removeProperty(ConsumeKafkaRecord_3.GROUP_ID);
        ...
        runner.setProperty(ConsumeKafkaRecord_3.GROUP_ID, "");
    ...
    public void validateGetAllMessages() {
        ...
        runner.setProperty(ConsumeKafkaRecord_3.TOPICS, "foo,bar");
        runner.setProperty(ConsumeKafkaRecord_3.GROUP_ID, groupName);
        runner.setProperty(ConsumeKafkaRecord_3.AUTO_OFFSET_RESET, ConsumeKafkaRecord_3.OFFSET_EARLIEST);
        runner.run(1, false);
    ...
    public void validateGetAllMessagesPattern() {
        ...
        runner.setProperty(ConsumeKafkaRecord_3.TOPICS, "(fo.*)|(ba)");
        runner.setProperty(ConsumeKafkaRecord_3.TOPIC_TYPE, "pattern");
        runner.setProperty(ConsumeKafkaRecord_3.GROUP_ID, groupName);
        runner.setProperty(ConsumeKafkaRecord_3.AUTO_OFFSET_RESET, ConsumeKafkaRecord_3.OFFSET_EARLIEST);
        runner.run(1, false);
    ...
    public void testJaasConfigurationWithDefaultMechanism() {
        ...
        runner.setProperty(ConsumeKafkaRecord_3.SECURITY_PROTOCOL, SecurityProtocol.SASL_PLAINTEXT.name());
        runner.assertNotValid();

        runner.setProperty(ConsumeKafkaRecord_3.KERBEROS_SERVICE_NAME, "kafka");
        runner.assertNotValid();

        runner.setProperty(ConsumeKafkaRecord_3.KERBEROS_PRINCIPAL, "nifi@APACHE.COM");
        runner.assertNotValid();

        runner.setProperty(ConsumeKafkaRecord_3.KERBEROS_KEYTAB, "not.A.File");
        runner.assertNotValid();

        runner.setProperty(ConsumeKafkaRecord_3.KERBEROS_KEYTAB, "src/test/resources/server.properties");
        runner.assertValid();
    }
    ...
    public void testJaasConfigurationWithPlainMechanism() {
        ...
        runner.setProperty(ConsumeKafkaRecord_3.SASL_MECHANISM, SaslMechanism.PLAIN.getValue());
        runner.assertNotValid();

        runner.setProperty(ConsumeKafkaRecord_3.SASL_USERNAME, "user1");
        runner.assertNotValid();

        runner.setProperty(ConsumeKafkaRecord_3.SASL_PASSWORD, "password");
        runner.assertValid();

        runner.removeProperty(ConsumeKafkaRecord_3.SASL_USERNAME);
        runner.assertNotValid();
    }
    ...
    public void testJaasConfigurationWithScram256Mechanism() {
        ...
        runner.setProperty(ConsumeKafkaRecord_3.SASL_MECHANISM, SaslMechanism.SCRAM_SHA_256.getValue());
        runner.assertNotValid();
    ...
    public void testJaasConfigurationWithScram512Mechanism() {
        ...
        runner.setProperty(ConsumeKafkaRecord_3.SASL_MECHANISM, SaslMechanism.SCRAM_SHA_512.getValue());
        runner.assertNotValid();
    ...
    public void testNonSaslSecurityProtocol() {
        ...
        runner.setProperty(ConsumeKafkaRecord_3.SECURITY_PROTOCOL, SecurityProtocol.PLAINTEXT.name());
        runner.assertValid();
    }

...
public class ITConsumeKafka_3 {
    ...
    public void validateGetAllMessages() {
        ...
        ConsumeKafka_3 proc = new ConsumeKafka_3() {
            @Override
        ...
        runner.setProperty(ConsumeKafka_3.BOOTSTRAP_SERVERS, "0.0.0.0:1234");
        runner.setProperty(ConsumeKafka_3.TOPICS, "foo,bar");
        runner.setProperty(ConsumeKafka_3.GROUP_ID, groupName);
    ...
    public void validateGetAllMessagesPattern() {
        ...
        final TestRunner runner = TestRunners.newTestRunner(proc);
        runner.setProperty(ConsumeKafka_3.BOOTSTRAP_SERVERS, "0.0.0.0:1234");
        runner.setProperty(ConsumeKafka_3.TOPICS, "(fo.*)|(ba)");
        runner.setProperty(ConsumeKafka_3.TOPIC_TYPE, "pattern");
        runner.setProperty(ConsumeKafka_3.GROUP_ID, groupName);
        runner.setProperty(ConsumeKafka_3.AUTO_OFFSET_RESET, ConsumeKafka_3.OFFSET_EARLIEST);
        runner.run(1, false);

...
public class JettyServer implements NiFiServer, ExtensionUiLoader {
    ...
    private Handler loadInitialWars(final Set<Bundle> bundles) {
        ...
        extensionUiInfo.contentViewerServletContexts.forEach((contextPath, servletContext) ->
                webContentViewerContext.setAttribute(contextPath, servletContext));
    ...
    private ExtensionUiInfo loadWars(final Map<File, Bundle> warToBundleLookup) {
        ...
        return new ExtensionUiInfo(webAppContexts, mimeMappings, componentUiExtensionWebContexts, contentViewerWebContexts,
                componentUiExtensionsByType, contentViewerServletContexts);
    }
